...
from jie import Chaojiying_Client
...
class VerificationClick(object):
    ...
    def __init__(self, user, pw, soft_id):
        ...
        self.driver = webdriver.Chrome(chrome_options=chrome,
                                       executable_path='C:\\Users\\liu\\Desktop\\chromedriver.exe')
    ...
    def get_action(self):
        ...
        button = self.wait.until(expected_conditions.presence_of_element_located((
            By.XPATH, '//*[@class="tcapt_item is-center"]//*[@class="yidun_tips"]'
        )))
        # print(button)
    ...
    def get_img(self):
        ...
        location = self.wait.until(expected_conditions.visibility_of_element_located((
            By.XPATH, '//*[@class="tcapt_item is-center"]//*[@class="yidun_bg-img"]'
        ))).location
...
if __name__ == '__main__':
    a = VerificationClick('lre1212', '1314520zy', '921694')
    a.run()